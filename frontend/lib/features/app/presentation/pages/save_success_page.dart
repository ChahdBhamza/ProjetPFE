...
class DetectionSuccessPage extends StatefulWidget {
  const DetectionSuccessPage({super.key});

  @override
  State<DetectionSuccessPage> createState() => _DetectionSuccessPageState();
}

class _DetectionSuccessPageState extends State<DetectionSuccessPage>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _scaleAnimation;
  late Animation<double> _fadeAnimation;
              ...
              child: ScaleTransition(
                ...
                child: Column(
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: CircularProgressIndicator(
                            valueColor: AlwaysStoppedAnimation<Color>(
                                CybersightTheme.accent.withOpacity(0.55)),
                            strokeWidth: 2,
                          ),
                        ),
                        Container(
                    ...
                    const SizedBox(height: 10),
                    Text(
                      'Well done! Your equipment has been identified.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.plusJakartaSans(
                        color: Colors.white54,
                        fontSize: 12,
